...
class ServiceSpecialTratment(models.Model):
    _name = 'service.special.tratment'
    _description = 'Service Special Tratment'
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            sequence = self.env['ir.sequence'].next_by_code('service_special_tratment')
